...
- [ ] **#209** Managed settings flow — done: `PlatformManagedSettingsFlowLogic`, `PlatformManagedSettingsTopLevelState`, `anyHashableBinding` → `selectedCategory`; pending: Layer 4 modifier, iPhone stack routing, compile-time pane tree, sub-pane stack, example
