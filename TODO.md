...
- [ ] **#209** Managed settings flow — done: L4 APIs, guide (`Framework/docs/ManagedPlatformSettingsFlowGuide.md`), compile-checked example test; pending: result-builder or richer pane tree if desired, full GitHub acceptance review/close
