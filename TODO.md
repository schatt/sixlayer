...
- [ ] **#209** Managed settings flow — done slices: `PlatformManagedSettingsFlowLogic`, `PlatformManagedSettingsTopLevelState` (TDD); pending: Layer 4 modifier, `AnyHashable` binding helper, iPhone stack routing, compile-time pane tree, sub-pane stack, example
