...
- [ ] **#209** Managed settings flow — done: flow logic, top-level state, `anyHashableBinding`, `platformManagedSettingsTopLevel_L4` → `platformSettingsContainer_L4`; pending: iPhone stack routing, compile-time pane tree, sub-pane stack, example/docs
