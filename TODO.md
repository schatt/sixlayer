...
- [ ] **#208** Stress matrix (resize churn, localization, RTL, Dynamic Type, persistence): slice 1 — `layer4CompactPresentationForTransition` + unit tests (done); remaining matrix coverage pending
