...
- [ ] **#209** Managed settings flow — done: L4 APIs, `selectTopLevelPane`, guide + Layer4 README link, compile-checked example; pending: optional result-builder / richer pane tree, GitHub acceptance review/close
