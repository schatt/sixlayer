...
- [ ] **#209** Managed settings flow — done: flow logic, top-level state, `anyHashableBinding`, `platformManagedSettingsTopLevel_L4`, iPhone `navigationDestination(isPresented:)` + `iPhoneTopLevelDetailNavigationIsPresented`; pending: compile-time pane tree, sub-pane stack API, example/docs, full acceptance
