...
### **Patch release**
🔧 **Patch**: Window/container resize — app-nav single-sidebar column sizing and intelligent card reflow on width and height (#330). See [RELEASE_v8.1.1.md](Development/RELEASE_v8.1.1.md).
