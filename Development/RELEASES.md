...
**Note**: macOS XCUITest deep-link hosts (#316), parallel suite policy (#335), unit-test isolation follow-ups (#334/#337), CI Gitea CA trust (#336).
**Next Release**: TBD

---

## 🎯 **v8.2.0 - macOS UITest deep-links and parallel test hygiene** (TBD)

### **What's in v8.2.0:**
- Minor release (#316, #334–#337). See [RELEASE_v8.2.0.md](RELEASE_v8.2.0.md) for details.
...
### **What's in v8.1.1:**
- Patch release (#330, #315, #331, #332, #333). See [RELEASE_v8.1.1.md](RELEASE_v8.1.1.md) for details.
...
## 🎯 **v7.5.13 - Modal sheet chrome; DynamicForm header visibility; form toolbar a11y** (April 2026)

### **What's in v7.5.13:**
- Patch release. See [RELEASE_v7.5.13.md](RELEASE_v7.5.13.md) for details.

**See [RELEASE_v7.5.13.md](RELEASE_v7.5.13.md) for complete release notes.**
...
## 🎯 **v7.5.5** (February 2026)

### **What's in v7.5.5:**
- Patch release. See [RELEASE_v7.5.5.md](RELEASE_v7.5.5.md) for details.

**See [RELEASE_v7.5.5.md](RELEASE_v7.5.5.md) for complete release notes.**
...
## 🎯 **v7.5.1 - platformFrame Min Clamping Fix** (February 7, 2026)

### **What's Fixed:**

#### **🔧 platformFrame min constraint clamping on non-macOS**
- **Bug**: minWidth/minHeight were not clamped on iOS, watchOS, tvOS, or visionOS when larger than the display, causing overflow or clipping.
- **Fix**: Min constraints are now capped at 90% of available space on all platforms (matching macOS behavior).

**See [RELEASE_v7.5.1.md](RELEASE_v7.5.1.md) for complete release notes.**
