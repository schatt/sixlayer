...
**Note**: Window/container resize (#330) and framework-owned adaptive app-nav sidebar / icon-rail (#331).
**Next Release**: TBD
...
### **What's in v8.1.1:**
- Patch release (#330, #331, #332, #333). See [RELEASE_v8.1.1.md](RELEASE_v8.1.1.md) for details.
