...
| `platformMapViewWithCurrentLocation_L4` | TBD | TBD | N/A | `PlatformMapComponentsLayer4ComponentAccessibilityTests` | Location service host; extend when stable in CI. |
