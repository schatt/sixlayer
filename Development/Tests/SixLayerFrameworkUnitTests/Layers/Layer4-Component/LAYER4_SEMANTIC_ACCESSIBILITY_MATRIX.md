...
| `platformNavigationBarTitleDisplayMode_L4` | Y (header chrome when chained; iOS applies bar display mode) | N/A | N/A | `Layer4UITests` | `Layer4SemanticAccessibilityCriterionTests.testPlatformNavigationBarTitleDisplayModeInline_preservesHeaderSemantics` |
...
| `platformRowActions_L4` | Y (named compliance on row anchor) | N/A | N/A | `Layer4UITests` | `Layer4SemanticAccessibilityCriterionTests.testPlatformRowActions_L4_exposesNamedComplianceOnRowAnchor` |
| `platformContextMenu_L4` | Y (named compliance on anchor) | N/A | N/A | `Layer4UITests` | `Layer4SemanticAccessibilityCriterionTests.testPlatformContextMenu_L4_exposesNamedComplianceOnAnchorTree` |
| `platformPhotoPicker_L4` | Y (`.button` or named compliance) | N/A | N/A | `PlatformPhotoComponentsLayer4ComponentAccessibilityTests`, `Layer4UITests` | `Layer4SemanticAccessibilityCriterionTests.testPlatformPhotoPicker_L4_exposesNamedComplianceOrButtonSemantics` |
| `platformPhotoDisplay_L4` | Y (contract id / image / button / static text) | N/A | N/A | `PlatformPhotoComponentsLayer4*` | `Layer4SemanticAccessibilityCriterionTests.testPlatformPhotoDisplay_L4_exposesContractIdentifierOrImageSemantics` |
| `platformCameraInterface_L4` | Y (named compliance / button on iOS host) | N/A | N/A | `Layer4UITests`, photo suites | `Layer4SemanticAccessibilityCriterionTests.testPlatformCameraInterface_L4_exposesNamedComplianceOnHostedTree` (iOS) |
| `platformCameraPreview_L4` | Y (named compliance on preview host) | N/A | N/A | `PlatformCameraPreviewViewTests` | `Layer4SemanticAccessibilityCriterionTests.testPlatformCameraPreview_L4_exposesNamedComplianceOnHostedTree` (iOS) |
| `platformMapView_L4` | Y (named `platformMapView_L4` / SixLayer on hosted map) | N/A | N/A | `PlatformMapComponentsLayer4ComponentAccessibilityTests` | `Layer4SemanticAccessibilityCriterionTests.testPlatformMapView_L4_exposesNamedComplianceOnHostedTree` (iOS 17+ / macOS 14+) |
| `platformMapViewWithCurrentLocation_L4` | Y (named compliance on hosted map) | N/A | N/A | `PlatformMapComponentsLayer4ComponentAccessibilityTests` | `Layer4SemanticAccessibilityCriterionTests.testPlatformMapViewWithCurrentLocation_L4_exposesNamedComplianceOnHostedTree` (iOS 17+) |
...
| `platformVerticalSplit_L4` / `platformHorizontalSplit_L4` | Y (pane `automaticCompliance` ids in hosted subtree) | N/A | Partial | `PlatformSplitViewLayer4Tests` | `Layer4SemanticAccessibilityCriterionTests.testPlatformVerticalSplit_L4_preservesPaneAutomaticComplianceUnderHosting`, `…testPlatformHorizontalSplit_L4_preservesPaneAutomaticComplianceUnderHosting` — rotor/read order → #255. |
...
| `platformFormContainer_L4` | Y (inner subtree ids) | N/A | Partial | `Layer4UITests`, `Layer4FormContainerTests` | `Layer4SemanticAccessibilityCriterionTests.testPlatformFormContainer_L4_preservesInnerAutomaticComplianceUnderHosting` — field values on pickers/toggles still staged. |
| Form field APIs (Layer 4) | TBD | TBD | Partial | form ViewInspector suites | Per-control value semantics staged. |
