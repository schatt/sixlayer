...
final class AccessibilityUITests: XCTestCase {
    ...
    func testPlatformPickerAccessibilityIdentifiers() throws {
        ...
        // Segments should have identifiers generated by automaticCompliance(identifierLabel: option)
        // Format: {namespace}.{screenContext}.{viewHierarchyPath}.{componentName}.{sanitizedLabel}.{elementType}
        // With includeComponentNames=true and includeElementTypes=true:
        // Auto-detection: Uses pickerName if provided, otherwise "element"
        // Since PlatformPickerTestView uses pickerName: "PlatformPickerTest":
        // SixLayer.main.ui.PlatformPickerTest.{sanitizedOption}.View
        // Note: sanitizeLabelText converts to lowercase, so "Option1" becomes "option1"
        ...
        for option in segmentOptions {
            ...
            // Auto-detection: pickerName "PlatformPickerTest" is used as identifierName for segments
            let segmentIdentifier = "SixLayer.main.ui.PlatformPickerTest.\(sanitizedOption).View"
