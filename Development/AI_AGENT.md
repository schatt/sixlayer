...
- **v8.3.6** — Patch release: `displayOCR` / hints inference (#404); named host sentinel (#406); iOS GeometryProxy SIGTRAP (#408); test-lane / release-script hygiene (#381, #395, #400, #405, #409) (see [RELEASE_v8.3.6.md](RELEASE_v8.3.6.md))
