...
- **[AI_AGENT_v7.8.0.md](AI_AGENT_v7.8.0.md)** - Minor release: presentation profiles catalog (#277), item collection resolver / card row style (#272), DynamicForm draft key (#273), PlatformImage EXIF (#275), system actions (#256 / #169) (see [RELEASE_v7.8.0.md](RELEASE_v7.8.0.md))
