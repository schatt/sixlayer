...
[![Version](https://img.shields.io/badge/version-v8.3.6-blue.svg)](https://github.com/schatt/sixlayer/releases/tag/v8.3.6)
...
```swift
dependencies: [
    .package(url: "https://github.com/schatt/6layer.git", from: "7.8.2")
]
```
