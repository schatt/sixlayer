...
Adaptive compact date+time stacking via `platformDateTimeInput` (#481, #498); IntelligentFormView packing spacing from `formContainerSpacing` (#492); SPM copied `.xcstrings` resolution (#500–#502); CI destinations and SD150 form XCUI harness (#495–#497). See [RELEASE_v8.5.1.md](../Development/RELEASE_v8.5.1.md).
...
Layer 5 honesty: real iOS L5 haptic/swipe/PTR coverage (#423, #424); phantom performance APIs removed from docs (#425); `platformIOSLayout(keyboardAware:)` gone (#444); 14 placeholder Layer5 demo types deleted (#453). See [RELEASE_v8.4.0.md](../Development/RELEASE_v8.4.0.md).

## 🆕 What's New in v8.3.8

### Patch release

Hosted Environment identifier config (#437); host-managed picker dismiss policy (#441, #442). See [RELEASE_v8.3.8.md](../Development/RELEASE_v8.3.8.md).

## 🆕 What's New in v8.3.7

### Patch release

SPM ViewInspector version pin so consumers can use `from:` (#438); inspect-safe identifier/theme config (#435); OCR hint regex (#420/#430). See [RELEASE_v8.3.7.md](../Development/RELEASE_v8.3.7.md).

## 🆕 What's New in v8.3.6

### Patch release

`displayOCR` / stop inferring OCR flags from hints (#404); named compliance host sentinel (#406); iOS GeometryProxy SIGTRAP in ViewInspector walks (#408). See [RELEASE_v8.3.6.md](../Development/RELEASE_v8.3.6.md).

## 🆕 What's New in v8.3.5

### Patch release

FieldDisplayHints form layout (#385); PlatformPresentationSize (#384/#386); toolbar overflow Menu (#352); UITest MainActor (#387). See [RELEASE_v8.3.5.md](../Development/RELEASE_v8.3.5.md).

## 🆕 What's New in v8.3.4

### Patch release

XCUI host-land / one-launch sessions and Vision hang footguns (#366–#374). See [RELEASE_v8.3.4.md](../Development/RELEASE_v8.3.4.md).

## 🆕 What's New in v8.3.3

### Patch release

`.exactNamed` / `ExactNamedModifier` host-sentinel parity with `.named` (#364). See [RELEASE_v8.3.3.md](../Development/RELEASE_v8.3.3.md).

## 🆕 What's New in v8.3.2

### Patch release

Empty-state host-sentinel accessibility ids (`accessibilityHostIdentifier`, #359/#360); `platformPresentDestination_L4` (#358). See [RELEASE_v8.3.2.md](../Development/RELEASE_v8.3.2.md).
...
Xcode 27 beta compile fix — remove dead `#available` gates inside `@ViewBuilder` (#340). See [RELEASE_v8.2.1.md](../Development/RELEASE_v8.2.1.md).
...
ViewInspector 0.10 test infrastructure: hosted accessibility identifier collection (#314); **SixLayerViewInspectorTestKit** for consumers (#327); typed inspect helpers (#326); deprecated `Inspectable` conformance removal (#328). See [RELEASE_v8.1.0.md](../Development/RELEASE_v8.1.0.md).

## 🆕 What's New in v8.0.0

### Major release

App navigation chrome: navigation sheet toolbar leading control with phone / detailOnly visibility (#323); sidebar reveal chrome for split detail-only layouts (#324); iOS automatic vs explicit detailOnly fix (#325). `platformMenu` SwiftUI Menu on iOS (#321). See [RELEASE_v8.0.0.md](../Development/RELEASE_v8.0.0.md).

## 🆕 What's New in v7.9.0

### Minor release

HIG automatic compliance: minimum typography floors (#302) and system zoom (#303). Intelligent card viewport/layout: host hints, navigation chrome subtraction, content-aware height floor (#306–#309). Capability override test hygiene: tri-state on controls (#251), platform-aware precursors (#311), macOS card touch harness (#313). Sendable policy (#310). See [RELEASE_v7.9.0.md](../Development/RELEASE_v7.9.0.md).

## 🆕 What's New in v7.8.9
...
Dynamic Type typography: `DynamicFontResolver` (#295), design-token scaling (#294), scalable `platformSystem` and `platformDecorativeIconFont` (#296). See [RELEASE_v7.8.8.md](../Development/RELEASE_v7.8.8.md) and [TypographyMigration.md](docs/TypographyMigration.md).

## 🆕 What's New in v7.8.7

### Patch release

`PlatformTabStrip` public initializer for app-target consumers (#292). See [RELEASE_v7.8.7.md](../Development/RELEASE_v7.8.7.md).

## 🆕 What's New in v7.8.6

### Patch release

Vision OCR text-discovery bounding boxes in `OCROverlayView` with `OCRBoundingBoxLayout` geometry helpers (#291). See [RELEASE_v7.8.6.md](../Development/RELEASE_v7.8.6.md).

## 🆕 What's New in v7.8.5

### Patch release

Numeric form field display coercion for `Int`/`Double`/`NSNumber` prefills (#289); SD150/L4 XCUITest stabilization; deprecated API cleanup. See [RELEASE_v7.8.5.md](../Development/RELEASE_v7.8.5.md).
...
Layer 4 assistive visual adaptability matrix (#255) and semantic criterion evidence (#254); `platformMapView_L4` map contract accessibility and UIKit hosting; XCUITest scroll/query stabilization for L4 System and SD150; duplicate CloudKit sync status accessibility identifier fix. See [RELEASE_v7.8.2.md](../Development/RELEASE_v7.8.2.md).
...
Restores explicit list accessibility identifier runtime contract discoverability for UI-test consumers (Issue #257), with release-lane test stabilization updates. See [RELEASE_v7.7.1.md](../Development/RELEASE_v7.7.1.md).

## 🆕 What's New in v7.7.0

### Minor release

VisionKit live data scanner Layer 4 APIs (Issue #252) and namespaced runtime capability expansion/completion (Issue #253, including `Network`/`Media`/`Pasteboard`/`Accessibility`). See [RELEASE_v7.7.0.md](../Development/RELEASE_v7.7.0.md).

## 🆕 What's New in v7.6.0

### Minor release

Managed settings migration documentation and consumer migration guidance (Issue #215). See [RELEASE_v7.6.0.md](../Development/RELEASE_v7.6.0.md).

## 🆕 What's New in v7.5.6

### Patch release

See [RELEASE_v7.5.6.md](../Development/RELEASE_v7.5.6.md).
...
### Modifier debug logs gated (Patch)

All accessibility modifier debug logs only print when `AccessibilityIdentifierConfig.shared.enableDebugLogging` is true. See [RELEASE_v7.5.3.md](../Development/RELEASE_v7.5.3.md).

## 🆕 What's New in v7.5.2

### verboseMinClamping debug flag (Patch)

Optional `PlatformFrameHelpers.verboseMinClamping`; when `true`, logs when a min width or height is clamped to fit available space. Resolves [#183](https://github.com/schatt/sixlayer/issues/183). See [RELEASE_v7.5.2.md](../Development/RELEASE_v7.5.2.md).

## 🆕 What's New in v7.5.1

### platformFrame Min Clamping Fix (Patch)

Min constraints (`minWidth`/`minHeight`) are now clamped to 90% of available space on iOS, watchOS, tvOS, and visionOS when they exceed the display, preventing overflow. Matches macOS behavior. Fixes [#182](https://github.com/schatt/sixlayer/issues/182). See [RELEASE_v7.5.1.md](../Development/RELEASE_v7.5.1.md).

## 🆕 What's New in v7.5.0

### Minor Release

Documentation updates, test infrastructure improvements, release process refinements, and resolution of 20 issues from milestone v7.5.0. Fully backward compatible. See [RELEASE_v7.5.0.md](../Development/RELEASE_v7.5.0.md) for details.
