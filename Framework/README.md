...
[![Version](https://img.shields.io/badge/version-v7.7.1-blue.svg)](https://github.com/schatt/sixlayer/releases/tag/v7.7.1)
...
```swift
dependencies: [
    .package(url: "https://github.com/schatt/6layer.git", from: "7.7.0")
]
```
